...
final class OnlyValidOrderAllowedTest extends TestCase
{
    ...
    {
        $featureFileContents = $this->createMock(Entities\FeatureFileContents::class);
    ...
    public function testApplyOnScenarioAllGood()
    {
        ...
        $step = $this->createMock(Entities\Step::class);
        $step->lineNumber = 50;
